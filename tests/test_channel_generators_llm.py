...
GOOD_NOTEBOOKLM = {
    ...
    "hook": "미국 재무부가 국채를 다시 사들이기 시작했습니다.",
    "script": (
        "미국 재무부가 국채를 다시 사들이기 시작했습니다. "
        "2026년 8월 27일, 분기 국채 바이백 규모를 300억 달러로 발표했습니다. "
        "발표 직후 미국 10년물 국채금리는 4.05%로 내렸고 달러 인덱스는 101.2를 기록했습니다. "
        "그래서 이게 왜 중요할까요. 유동성이 부족한 구간을 재무부가 직접 사들이면 "
        "그 구간의 가격 변동성이 줄어들 수 있습니다. "
        "채권시장에서는 장기금리에 하방 압력이 실릴 수 있다는 해석이 나옵니다. "
        "반대로 다음 분기 바이백 규모가 줄어들면 이 흐름은 다시 뒤집힐 수 있습니다. "
        "앞으로는 다음 분기 재융자 발표, QRA를 지켜봐야 합니다. "
        "결국 중요한 건 바이백의 크기보다 재무부가 어느 구간을 지원하는지입니다."
    ),
    "chapters": [
        "Hook", "사건 설명", "개념 설명", "전달 경로", "채권시장",
